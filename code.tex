...
\newcommand{\doubleder}[2]{\ensuremath{\displaystyle\frac{d^2 #1}{d #2^2}}}
...
\newcommand{\doublepartialder}[2]{\ensuremath{\displaystyle\frac{\partial^2 #1}{\partial #2^2}}}
\newcommand{\doublepartialderk}[3]{\ensuremath{\bigbrac{\displaystyle\frac{\partial^2 #1}{\partial #2^2}}_{#3}}}
\newcommand{\mixedpartialder}[3]{\ensuremath{\displaystyle\frac{\partial^2 #1}{\partial #2 \partial #3}}}
\newcommand{\mixedpartialderk}[4]{\ensuremath{\bigbrac{\displaystyle\frac{\partial^2 #1}{\partial #2 \partial #3}}_{#4}}}
\newcommand{\npartialder}[3]{\ensuremath{\displaystyle\frac{\partial^{#3} #1}{\partial #2^{#3}}}}

% INTEGRAL CALCULUS %
\newcommand{\indefint}[3]{\ensuremath{\int\limits_{#2}^{#3} #1}}
\newcommand{\defint}[3]{\ensuremath{\left\lbrace#1\right\rbrace_{#2}^{#3}}}
\newcommand{\indefintinf}[1]{\ensuremath{\int\limits_{-\infty}^{+\infty} #1}}
\newcommand{\defintinf}[1]{\ensuremath{\left\lbrace#1\right\rbrace_{-\infty}^{\infty}}}
